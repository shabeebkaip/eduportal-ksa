      ...
      >
        <Card className="glass-effect border-white/10">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-bold gradient-text">Staff & Admin Login</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center mt-6">
               <Link to="/student-parent-login" className="inline-flex items-center text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors">
                 <Users className="w-4 h-4 mr-2" />
                 Are you a Student or Parent? Login Here
               </Link>
             </div>
          </CardContent>
        </Card>
